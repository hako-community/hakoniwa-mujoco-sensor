...
#
#   Usage: bash multi_sensor_viz_run.sh [window|headless]     (default: window)
...
[ -x "$BRIDGE" ] || { echo "not executable: $BRIDGE (build via examples/drone_envsim_sensors/build.bash)"; exit 2; }
