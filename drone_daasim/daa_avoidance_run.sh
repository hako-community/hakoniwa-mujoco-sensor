...
ENVXML="${M6_ENV:-$SENSOR_REPO/examples/drone_envsim_sensors/daa_bridge_scene/env.xml}"
DEMO="${M6_DEMO:-$SENSOR_REPO/examples/drone_envsim_sensors/lidar3d_pointcloud_pdu}"
...
HAKO_BINARY_PATH="$HAKO_BINARY_PATH" "$PYENV_PY" "$HERE/daa_sensor_bridge.py" \
