...
A-1 cross-language check for the 3D LiDAR (PointCloud2).
  ...
  C++:    lidar3d_pointcloud_pdu senses env.xml -> writes PointCloud2 PDU
  Python: decode PointCloud2, parse x,y,z,intensity, verify geometry

Config is fixed in lidar3d_pointcloud_pdu.cpp: channels=17 (v -40..40), width=361
