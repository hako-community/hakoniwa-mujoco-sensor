...
Default manifest: ../../config/drone_sensors/drone-sensors.json
...
CFG = os.path.normpath(os.path.join(HERE, "../../config/drone_sensors"))
SCHEMA = os.path.join(CFG, "drone-sensor-manifest.schema.json")
DEFAULT = os.path.join(CFG, "drone-sensors.json")
