...
B-2 check: the formal drone sensor manifest drives multi-sensor selection.
  ...
  1. validate config/drone_sensors/drone-sensors.json against the schema
...
Run: python3 verify_drone_manifest.py
"""
...
MANIFEST = os.path.normpath(os.path.join(HERE, "../../config/drone_sensors/drone-sensors.json"))
