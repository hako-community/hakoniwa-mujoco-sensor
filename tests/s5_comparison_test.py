...
from s5_capture_mujoco import DEFAULT_CONTRACT, capture
from s5_compare import compare
...
class S5ComparisonTest(unittest.TestCase):
    ...
    def test_fixture_pass_is_explicitly_not_actual_isaac(self):
        ...
        subprocess.run([sys.executable, str(Path(__file__).resolve().parents[1] / "tools/s5_compare.py"),
